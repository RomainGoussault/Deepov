...
./cutechess-cli.sh -engine cmd=DeepovCurrent -engine cmd=Deepov -each proto=uci tc=100/1 -rounds 100 -pgnout matchOuput.txt -recover -repeat -openings file=openings.pgn | while read line; do
