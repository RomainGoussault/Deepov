...
#	print(args)
    ...
    # Mandatory arguments
    cutechessCommand = (args.cutechess + ' -engine cmd=' + args.engine + ' dir=' + args.dir + ' -engine cmd=' + args.opponent + ' dir=' + args.dir)
 
    # Optional arguments
    cutechessCommand += (' -each proto=uci tc=' + args.time + ' -rounds ' + args.rounds + ' -pgnout ' + args.output + ' -openings file=' + args.book)
